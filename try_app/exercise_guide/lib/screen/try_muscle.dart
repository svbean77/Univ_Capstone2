...
import 'package:exercise_guide/screen/try_guide.dart';
import 'package:flutter/material.dart';

class TryMuscle extends StatelessWidget {
  const TryMuscle({Key? key}) : super(key: key);
  ...
  List<String> setExercise(int num) {
    ...
    switch (num) {
      ...
      case 2:
        ...
        exerciseName = "운동 2";
        exerciseImage =
        "https://www.musclewiki.com/media/uploads/male-kettlebell-single-leg-calf-raises-front.gif";
        equipment = '기구 2';
        difficulty = '난이도 2';
