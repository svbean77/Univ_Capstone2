            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text('등급 이미지', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text('팔 근육 아이콘', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text('사과 아이콘', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text('부위별 운동 아이콘', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.0),
                  Text('루틴 아이콘', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
            Container(
